...
namespace AppWeb1
{
    public partial class frmMantGrado : System.Web.UI.Page
    {
        ...
        //        try
        //        {
        //            int CodigoGrado = int.Parse(e.CommandArgument.ToString());

        //            this.txtId.Text = CodigoGrado.ToString();
        //            obj = objGradoDAO.ListarPorClave(Convert.ToInt32(this.txtId.Text));
        ...
        protected void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            int id = objGradoDAO.Agregar(obj);
        ...
        protected void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (this.txtId.Text != "")
            {
                ...
                objGradoDAO.Eliminar(this.txtId.Text);
