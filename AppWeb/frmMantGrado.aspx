<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmMantGrado.aspx.cs" Inherits="AppWeb.frmMantGrado" %>
...
<asp:gridview id="gvLista" runat="server" 
    ...
    <Columns>
        <asp:BoundField ReadOnly="True" DataField="CodigoGrado" HeaderText="ID" ItemStyle-Width="50px"></asp:BoundField>
