<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmMantUnidad.aspx.cs" Inherits="AppWeb.frmMantUnidad" %>
...
<asp:gridview id="gvLista" runat="server" 
    ...
    <Columns>
        <asp:BoundField ReadOnly="True" DataField="CodigoUnidad" HeaderText="ID" ItemStyle-Width="50px"></asp:BoundField>
