<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmMantCargo.aspx.cs" Inherits="AppWeb.frmMantCargo" %>
...
<asp:gridview id="gvLista" runat="server" 
    ...
    <Columns>
        <asp:BoundField ReadOnly="True" DataField="CodigoCargo" HeaderText="ID" ItemStyle-Width="50px"></asp:BoundField>
