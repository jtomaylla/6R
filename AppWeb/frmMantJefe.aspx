<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmMantJefe.aspx.cs" Inherits="AppWeb.frmMantJefe" %>
...
<asp:gridview id="gvLista" runat="server" 
    ...
    <Columns>
        <asp:BoundField ReadOnly="True" DataField="CodigoJefe" HeaderText="ID" ItemStyle-Width="50px"></asp:BoundField>
